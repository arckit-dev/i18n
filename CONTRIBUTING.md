...
```bash
git clone git@github.com:arckit-dev/i18n.git
cd i18n
```
...
| `CODECOV_TOKEN` | Codecov upload token | [app.codecov.io](https://app.codecov.io/gh/arckit-dev/i18n/config/general) → Repository upload token |

### Workflows

| Workflow | Trigger | Description |
|----------|---------|-------------|
| [CI](.github/workflows/ci.yml) | Push to `main` / PR | Lint, type-check, test, build, package quality checks, coverage upload to [Codecov](https://codecov.io/gh/arckit-dev/i18n) |
